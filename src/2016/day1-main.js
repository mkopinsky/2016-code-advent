...
console.log('Part 1: Distance after all travels', day1.getDistanceAfterWalk(input));
console.log('Part 2: Distance to first repeated location', day1.getDistanceOfRepeatedLocation(input));
